...
Each module is a Git repository.

Each module version is indicated by a git tag; this way it's straightforward and reproducible to install a specific version
of a module at any time.
